...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-08-2022 a las 06:20:16
...
--
-- Estructura de tabla para la tabla `listado_inventario`
--
...
--
-- Volcado de datos para la tabla `listado_inventario`
--
...
INSERT INTO `residuo` (`id_residuo`, `peso`, `cantidad`, `id_servicio`, `id_listado_inventario`) VALUES
(24, 5, 15, 24, 2),
(25, 4, 4, 24, 4),
(26, 3, 4, 24, 5);
...
--
-- Indices de la tabla `listado_inventario`
--
...
--
-- AUTO_INCREMENT de la tabla `listado_inventario`
--
ALTER TABLE `listado_inventario`
