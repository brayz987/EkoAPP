...
<head>
    ...
    <title>Nueva plantilla de correo electrC3B3nico 2022-08-24</title>
    ...
    <style type="text/css">
        ...
        td .es-button-border:hover a.es-button-2 {
            background: #d07819 !important;
            border-color: #d07819 !important;
        }
                                                    ...
                                                    <td align="center" valign="top"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:108px;color:#181818;font-size:72px">
                                                                        <strong><span>🍃&nbsp;Eko
                                                                                App&nbsp;🌳</span></strong></p>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <h1
                                                                        ...
                                                                        ¡Se ha creado su servicio de recolecta!</h1>
                                                                    <p
                                                                        ...
                                                                        <strong>ID: <?php echo $idServicio ;?></strong></p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#131313;font-size:16px">
                                                                        Recurde que puede consultar, editar o cancelar
                                                                        su servicio desde su perfil en nuestra pagina
                                                                        web</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center" style="padding:0;Margin:0"><span
                                                                        class="es-button-border es-button-border-3"
                                                                        style="border-style:solid;border-color:#2CB543;background:#e69138;border-width:0px;display:inline-block;border-radius:5px;width:auto"><a
                                                                            href="https://www.ekoapp.com"
                                                                            class="es-button es-button-2"
                                                                            target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;border-style:solid;border-color:#e69138;border-width:10px 20px 10px 20px;display:inline-block;background:#e69138;border-radius:5px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;font-weight:bold;font-style:normal;line-height:24px;width:auto;text-align:center">Entre
                                                                            Aqui!</a></span></td>
                                                            </tr>
                                                        </table>
                                                    </td>
